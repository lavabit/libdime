...
// FIXME perhaps the inner struct can be changed into a single array of pointers. But maybe not. If you read this and have an opinion on this, leave it commented below.
typedef struct {
