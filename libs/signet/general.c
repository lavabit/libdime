...
/*0*/	SKEY_EMPTY,
/*1*/   {     1,     1,     0, 0, 0, ED25519_KEY_SIZE,     HEX,           "Primary-Organizational-Key", "Primary organizational signing key, also located in the DIME record SIGNET." },
/*2*/   {     0,     0,     1, 0, 0, ED25519_KEY_SIZE,     HEX,         "Secondary-Organizational-Key", "Secondary organizational signing key fields." },
/*3*/   {     1,     1,     0, 0, 0, EC_PUBKEY_SIZE,      HEX,                       "Encryption-Key", "The ECC public key used to encrypt data sent to the holder of organizational SIGNET holder." },
...
/*253*/ {     1,     1,     0, 0, 0,  ED25519_SIG_SIZE,    HEX,             "Organizational-Signature", "HMAC of all the previous fields signed by the organization POK." },
/*254*/ {     1,     1,     0, 0, 1,  0,		   UNICODE,                "Signet-Identifier", "Mail service domain name." },
/*255*/ {     1,     1,     0, 0, 0,  ED25519_SIG_SIZE,    HEX,             "Organizational-Signature", "HMAC of all the previous fields including the Signet-Identifer field signed by the organization POK." }, // TODO
};
...
//	{ .required .unique .flags .bytes_name_size .bytes_data_size, .data_size, .data_type, .name, .description }
/*0*/	SKEY_EMPTY,
/*1*/	{     1,     1,     0, 0, 0, ED25519_KEY_SIZE,     HEX,                          "Signing-Key", "User signing key." },
/*2*/	{     1,     1,     0, 0, 0, EC_PUBKEY_SIZE,       HEX,                       "Encryption-Key", "User encryption key which is used to encrypt messages to the holder of the user signet." },
/*3*/	{     0,     0,     1, 0, 1, 0,     		   HEX,             "Alternate-Encryption-Key", "Alternative user encryption keys." },
/*4*/   {     0,     1,     0, 0, 0, ED25519_SIG_SIZE,     HEX,                              "Custody", "The 'Chain-of-custody' Signature. HMAC of the previous fields signed by user's previous private signing key." },
/*5*/   {     1,     1,     0, 0, 0, ED25519_SIG_SIZE,     HEX,                       "User-Signature", "User's signature and the last field of the User's SSR. HMAC of the previous fields signed by user's private Signing key." },
/*6*/   {     1,     1,     0, 0, 0, ED25519_SIG_SIZE,     HEX,   	    "Organizational-Signature", "HMAC of the fields provided by the user's SSR signed by the Organization's private Signing Key." },
...
//	{ .required .unique .flags .bytes_name_size .bytes_data_size, .data_size, .data_type, .name, .description }
/*0*/	SKEY_EMPTY,
/*1*/	{     1,     1,     0, 0, 0, ED25519_KEY_SIZE,     HEX,                 "User-Signing-Key", "User signing key." },
/*2*/	{     1,     1,     0, 0, 0, EC_PUBKEY_SIZE,       HEX,              "User-Encryption-Key", "User encryption key which is used to encrypt messages to the holder of the user signet." },
/*3*/	{     0,     0,     1, 0, 1,  0,     		   HEX,         "Alternate-Encryption-Key", "Alternative user encryption keys." },
/*4*/   {     0,     1,     0, 0, 0, ED25519_SIG_SIZE,     HEX,       "Chain-Of-Custody-Signature", "The 'Chain-of-custody' Signature. HMAC of the previous fields signed by user's previous private signing key." },
/*5*/   {     1,     1,     0, 0, 0, ED25519_SIG_SIZE,     HEX,               "User-Ssr-Signature", "User's signature and the last field of the User's SSR. HMAC of the previous fields signed by user's private Signing key." },
