 ...
 */
unsigned char *
_ec_sign_data(unsigned char const *hash, size_t hlen, EC_KEY *key, size_t *siglen) {
	ECDSA_SIG *signature;
 ...
 */
unsigned char *
_ec_sign_sha_data(unsigned char const *data, size_t dlen, unsigned int shabits, EC_KEY *key, size_t *siglen) {
	unsigned char hashbuf[SHA_512_SIZE];
 ...
 */
EC_KEY *
_deserialize_ec_pubkey(unsigned char const *buf, size_t blen, int signing) {
	EC_KEY *result;
	int nid;
 ...
 */
EC_KEY *
_deserialize_ec_privkey(unsigned char const *buf, size_t blen, int signing) {
	EC_KEY *result;
	int nid;
 ...
 */
ED25519_KEY *
_deserialize_ed25519_pubkey(unsigned char const *serial_pubkey) {
	ED25519_KEY *key;
 ...
 */
ED25519_KEY *
_deserialize_ed25519_privkey(unsigned char const *serial_privkey) {
	ED25519_KEY *key;
 ...
 */
void *
_ecies_env_derivation(void const *input, size_t ilen, void *output, size_t *olen) {
